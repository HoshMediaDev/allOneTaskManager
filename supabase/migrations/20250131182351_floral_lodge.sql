...
-- Ensure any remaining 'default' location_ids are updated to a valid value
UPDATE contacts
SET location_id = (
  SELECT location_id 
  FROM boards 
...
COMMENT ON TABLE contacts IS 'Contacts table with enforced non-default location IDs';
