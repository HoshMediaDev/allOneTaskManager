...
-- Set RLS context function
CREATE OR REPLACE FUNCTION set_auth_context(location_id text, user_email text)
RETURNS void AS $$
BEGIN
  PERFORM set_config('app.location_id', location_id, false);
